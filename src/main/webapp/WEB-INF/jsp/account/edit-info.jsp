...
<div style="margin-left:80px">
    <h1 style="margin-top: 10px">Edit user_profile</h1><br>
...
<%--                   value="<c:out value='${user_profile.id}'/>"/>--%>
<%--        </label>--%>

<%--        <label>--%>
<%--            <strong> Name: </strong>--%>
<%--            <input style="margin-left: 5px" type="text" name="name" placeholder="Your name..."--%>
<%--                   value="<c:out value='${user_profile.name}'/>" pattern="[A-Z][a-z]{0,12}"--%>
...
<%--                   value="<c:out value='${user_profile.surname}'/>" pattern="[A-Z][a-z]{2,}"--%>
...
<%--                   value="<c:out value='${user_profile.birthday}'/>"/>--%>
<%--        </label>--%>
<%--        <br>--%>
...
<%--            <select name="gender">--%>
<%--                <option hidden selected value="<c:out value='${user_profile.gender}'/>">${user_profile.gender} </option>--%>
...
<%--                   value="<c:out value='${user_profile.phone}'/>"/>--%>
<%--        </label>--%>
<%--        <br>--%>
...
<%--            <select name="country">--%>
<%--                <option hidden selected value="<c:out value='${user_profile.country}'/>">${user_profile.country} </option>--%>
...
<%--                   value="<c:out value='${user_profile.city}'/>"/>--%>
<%--        </label>--%>
<%--        <br>--%>
...
<%--                   value="<c:out value='${user_profile.zip}'/>" pattern="[0-9]{0,}"/>--%>
<%--        </label>--%>
<%--        <br>--%>
...
<%--                <c:out value="${user_profile.bio}"/>--%>
<%--            </textarea>--%>
<%--        </label>--%>
<%--        <br>--%>

<%--        <input type="hidden" name="avatar" value="<c:out value='${user_profile.avatar}'/>"/>--%>
...
<%--        <input type="hidden" name="user_id" value="<c:out value='${user_user_profile.user_id}'/>"/>--%>
<%--        <input type="hidden" name="user_profile_id" value="<c:out value='${user_user_profile.user_profile_id}'/>"/>--%>
...
<%--    </form>--%>
    ...
    <form action="${pageContext.request.contextPath}/account/edit-info" method="post">
        ...
        <label>
            <strong> Email: </strong>
            <input style="margin-left: 5px" type="email" name="email" placeholder="Email Address..."
                   value="<c:out value='${user_profile.email}'/>"/>
        </label>
        <br>

...
//        if (TheGame.getInfo() == 1) {
//            String cases = "\n Your Turn \n" +
//                    "1. Hit " + name + " on " + getDefaultDamage() + " health point \n2. Strike with magic on " + randomDamage + " health point " +
//                    "\n3. Restore " + res + " health point, Need " + getHealCast() + " Mana, You Have " + manaFinal + " Mana" +
...
//                    "\n3. Restore " + res + " health point, Need " + getHealCast() + " Mana, You Have " + manaFinal_wOut + " Mana" +
...
//                System.out.print(nowBossHave + ((healthPoint + restoreCreature) - getDefaultDamage()) + hp);
//                healthPoint = (healthPoint + restoreCreature) - getDefaultDamage();
//                if (healthPoint <= 0) {
